...
urlpatterns = [
    ...
    path('cancel-bid/<int:id>', views.cancel_bid, name='cancel_bid'),
    ...
    path('bid-single-item/<int:id>', views.bid_single_item, name='bid_single_item'),
    ...
    path('accept_bid/<int:id>',views.accept_bid, name='accept_bid'),
]
